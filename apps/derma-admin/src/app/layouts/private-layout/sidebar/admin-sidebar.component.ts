...
interface NavItem {
  ...
  readonly icon: 'dashboard' | 'agenda' | 'pacientes' | 'historial' | 'tratamientos' | 'finanzas' | 'staff' | 'config';
}
...
const NAV_ITEMS: readonly NavItem[] = [
  ...
  { id: 'finanzas', label: 'Finanzas', path: '/admin/finanzas', icon: 'finanzas', roles: [RolUsuario.ADMIN] },
...
export class AdminSidebarComponent {
  ...
  getIcon(icon: NavItem['icon']): string {
    const icons: Record<string, string> = {
      ...
      finanzas: 'M11.8 10.9c-2.27-.59-3-1.38-3-2.15 0-1.09 1.01-1.85 2.7-1.85 1.78 0 2.44.85 2.5 2.1h2.21c-.07-1.72-1.12-3.3-3.21-3.81V3h-3v2.16c-1.94.42-3.5 1.68-3.5 3.61 0 2.31 1.91 3.46 4.7 4.13 2.5.6 3 1.48 3 2.41 0 .9-.84 1.85-2.85 1.85-2.11 0-2.79-.85-2.85-2.1H8.02c.02 1.65 .88 2.9 2.69 3.32V21h3v-2.15c1.60-.41 2.74-1.61 2.74-3.27 0-2.3-1.88-3.39-4.77-4.03l-1.29-.24z',
