...
interface NavItem {
  ...
  readonly icon:
    ...
    | 'tareas'
    | 'insumos';
  /** Si es false, `/ruta/hijo` también marca activo el ítem (ej. detalle de videoconsulta). */
...
const NAV_ITEMS: readonly NavItem[] = [
  ...
  { id: 'agenda', label: 'Agenda', path: '/admin/agenda', icon: 'agenda', roles: [RolUsuario.ADMIN, RolUsuario.DERMATOLOGO, RolUsuario.RECEPCIONISTA] },
  {
    ...
    path: '/admin/videoconsultas',
    icon: 'videoconsulta',
    roles: [RolUsuario.ADMIN, RolUsuario.DERMATOLOGO, RolUsuario.RECEPCIONISTA],
  ...
  { id: 'tareas',          label: 'Tareas',           path: '/admin/tareas',           icon: 'tareas', roles: [RolUsuario.ADMIN] },
  { id: 'tareas-historial', label: 'Historial Tareas', path: '/admin/tareas/historial', icon: 'tareas', roles: [RolUsuario.ADMIN] },
  { id: 'mis-tareas',       label: 'Mis Tareas',       path: '/admin/mis-tareas',       icon: 'tareas', roles: [RolUsuario.DERMATOLOGO, RolUsuario.RECEPCIONISTA, RolUsuario.EMPLEADO] },
  { id: 'insumos',          label: 'Insumos',          path: '/admin/insumos',          icon: 'insumos', roles: [RolUsuario.ADMIN, RolUsuario.DERMATOLOGO, RolUsuario.RECEPCIONISTA, RolUsuario.EMPLEADO] },
...
export class AdminSidebarComponent {
  ...
  getIcon(icon: NavItem['icon']): string {
    const icons: Record<string, string> = {
      ...
      insumos: 'M20.25 7.5l-.625 10.632a2.25 2.25 0 01-2.247 2.118H6.622a2.25 2.25 0 01-2.247-2.118L3.75 7.5M10 11.25h4M3.375 7.5h17.25c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125z',
